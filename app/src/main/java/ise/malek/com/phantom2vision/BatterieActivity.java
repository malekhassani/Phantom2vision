...
public class BatterieActivity extends Activity {
    ...
    private void checkConnectState(){
        ...
        BatterieActivity.this.runOnUiThread(new Runnable(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDischargeDaysBtn.setOnClickListener(new View.OnClickListener() {
        ...
        mGetFirmwareVersion.setOnClickListener(new View.OnClickListener() {
    ...
    private void setResultToToast(String result){
        Toast.makeText(BatterieActivity.this, result, Toast.LENGTH_SHORT).show();
    }
